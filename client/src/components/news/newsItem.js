...
class NewsItem extends Component {
    ...
    render() {
        ...
        <li className='list-group-item news' id={this.props.id}>
            <a href={this.props.link}><h4 className='news-title'>{this.props.title}</h4></a>
            ...
            <div className='row news-bulk'> 
                <div className='col-md-6'>
                    <p className='news-brief'>"{this.props.summary}..." <a href={this.props.link} className='news-link'>Read the Full Story</a></p>
                </div>
                <div className='col-md-6'>
