...
export const CalEventItem = props => (
    <li className={props.bk % 2 === 0 ? 'animated fadeIn' : 'alternate animated fadeIn'} id={props.id} data-time={props.test}>
        <a href={props.link} target='_blank' rel='noopener noreferrer' className='eventsToday'>
