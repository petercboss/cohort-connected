        ...
        <li className='forumIndexItem animated fadeIn' id={this.props.id}>
            <a onClick={() => {
                ...
                <h5 className='forumIndex-byline'>
                    ...
                    <span className='answerCount-dynamic'>{
                        this.props.answers === 0 ? 'Be the First to Solve!' : 
                        this.props.answers === 1 ? this.props.answers + ' Solution Provided' :
                        this.props.answers + ' Solutions Provided'}</span>
                </h5>
